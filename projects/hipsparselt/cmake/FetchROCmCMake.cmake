...
if(NOT ROCmCMakeBuildTools_FOUND)
  ...
  if(NOT rocm-cmake_POPULATED)
    ...
    # message(STATUS "Added subdirectory: ${rocm-cmake_SOURCE_DIR}")
    # add_subdirectory(${rocm-cmake_SOURCE_DIR} ${rocm-cmake_BINARY_DIR} EXCLUDE_FROM_ALL)
    message(STATUS "Added ROCm CMake modules path: ${rocm-cmake_SOURCE_DIR}/share/rocmcmakebuildtools/cmake")
